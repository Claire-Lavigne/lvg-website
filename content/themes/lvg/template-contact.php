...
<main>
        <div class="contact-title top-title" style="background-image: url(<?php echo get_template_directory_uri() . '/public/images/contact-image.jpg ' ?> )" >
            ...
            <img class="contact-picture" src="<?php echo get_template_directory_uri() . '/public/images/laurent.jpg' ?>" alt="photograph picture"></div> 
        </div>
            ...
            <div class="contact__block">
                <div class="contact__rows">
                    <div class="contact__row">
                        ...
                        <p>
                           <a href="tel:+33681021789">06.81.02.17.89</a>
                        </p>
                    </div>
                    <div class="contact__row">
                        ...
                        <p>
                          <address>
                              <a href="http://maps.google.com/?q=LVG+Studio,432+route+de+Castres,81990+PUYGOUZON" target="_blank">
                                 432 route de Castres 81990 PUYGOUZON
                             </a>
                         </address>
                       </p>
                    </div>
                    ...
                    <div class="contact__row">
                        ...
                        <p>
                            <a href="mailto:lavignephotographe@gmail.com">lavignephotographe@gmail.com</a>
                        </p>
                    </div>
                </div>
            </div>
